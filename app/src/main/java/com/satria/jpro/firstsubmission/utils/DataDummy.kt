package com.satria.jpro.firstsubmission.utils
    ...
    fun generateDataTvShowDummy(): List<DataModel> {
        ...
        listTvShow.add(
            DataModel(
                ...
                poster = "https://www.themoviedb.org/t/p/original/yfyToia25GnvjY7FPAGaCm3lKRc.jpg",
                img_preview = "https://pbs.twimg.com/media/Dbz1WbjWsAAZsPH?format=jpg&name=900x900"
            )
        )
